(function ($) {
                ...
                self.save = function () {
                    self.$input.on('keyup', function (e) {
                     ...
                     //alert(key);
                        ...
                        value = 189 === key ? value.slice(0, -1) : value;
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Attention, you cannot add empty tag.',
            minLength: 'Attention, your tag must contain 2 characters at least',
            maxLength: 'Attention, your tag must not contain more than 30 characters.',
            max: 'Attention, number of tags must not exceed 30.',
            email: 'Attention, email address you entered is invalid.',
            exists: 'Attention, this tag already exists!',
            autocomplete_only: 'Attention, You have to determine value from the list',
            timeout: 8000
        }
    };
